package com.ttt.liveroom.room.window;
...
import ijkplayer.IRenderView;
import ijkplayer.IjkVideoView;
import ijkplayer.widget.AndroidMediaController;
...
public class PlayerActivityManager {
    ...
    public static final String TAG = "PlayerActivityManager";
    ...
    public void setMediaController(AndroidMediaController mediaController) {
    ...
    public PlayerActivityManager(final Object pullfragment, IjkVideoView ijkVideoView) {
        try {
        ...
        if (pullfragment instanceof Fragment) {
            this.activity = ((Fragment) pullfragment).getActivity();
        }
        if (pullfragment instanceof Activity) {
            this.activity = (Activity) pullfragment;
        }
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public PlayerActivityManager playInFullScreen(boolean fullScreen) {
        if (fullScreen) {
    ...
    public PlayerActivityManager onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public PlayerActivityManager onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public PlayerActivityManager onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public PlayerActivityManager onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener) {
     ...
     * @return
     */
    public PlayerActivityManager live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public PlayerActivityManager toggleAspectRatio() {
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public PlayerActivityManager onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener) {
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
